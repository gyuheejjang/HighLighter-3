  ...
  <div class="row-fluid">
    <div class="span12">
      <div class="page-header">
        <div class="row-fluid">
          <div class="span12">
            <h1 style="color:#4C4B4A">강사 회원 가입</h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <form role="form" id="comment_form" style="background:white" method="post">
          ...
          <div class="con_fil">
           ...
           <div class="con_fil">
            ...
            <input type="number" name="ext_exp" id="ext_exp" tabindex="3" required>년
            <input type="number" name="ext_exp" id="ext_exp" tabindex="3" required>개월
          </div>
           <div class="con_fil">
            <label for="bank">은행</label>
            <input type="text" name="bank" id="bank" class="textbox" tabindex="3">
          </div>
           <div class="con_fil">  
            <label for="bank_ac_num">계좌번호</label>
            <input type="text" name="bank_ac_num" id="bank_ac_num" class="textbox" tabindex="3" >
          </div>
           <div class="con_fil">
            <label for="college">학교</label>
            <input type="text" name="college" id="college" class="textbox" tabindex="3" required>
          </div>
           <div class="con_fil">
            <label for="college_dept">학과</label>
            <input type="text" name="college_dept" id="college_dept" class="textbox" tabindex="3" required>
          </div>
           <div class="con_fil">
