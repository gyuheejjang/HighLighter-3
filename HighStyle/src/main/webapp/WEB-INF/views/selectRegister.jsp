  ...
  <div class="row-fluid">
    <div class="span12" >
      <div class="page-header" >
        <div class="row-fluid">
          <div class="span12" >
            <h1 style="color:#4C4B4A">회원 가입</h1>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="span4  work-item graphics">
            ...
            <div class="sample work-item-image-container">
              <div class="work-item-overlay">
                <div class="inner">
                  <ul>
                    <li><a rel="prettyPhoto[gallery]" href="/highlighter/teacherRegister" class="gallery-btn">가입하기</a></li>
                    <li><a class="detail-link" href="work-details.html">강사 이용방법</a></li>
                  </ul>
                </div>
              </div>
              <img src="./resources/img/selectTeacher.png" alt=""> </div>
          </div>
          <div class="span4  work-item nature">
            ...
            <div class="sample work-item-image-container">
              <div class="work-item-overlay">
                <div class="inner">
                  <ul>
                    <li><a rel="prettyPhoto[gallery]" href="/highlighter/studentRegister" class="gallery-btn">가입하기</a></li>
                    <li><a class="detail-link" href="work-details.html">학생 이용방법</a></li>
                  </ul>
                </div>
              </div>
              <img src="./resources/img/selectStudent.png" alt=""> </div>
          </div>
          <div class="span4  work-item food">
            ...
            <div class="sample work-item-image-container">
              <div class="work-item-overlay">
                <div class="inner">
                  <ul>
                    <li><a rel="prettyPhoto[gallery]" href="./resources/img/work8.jpg" class="gallery-btn">가입하기</a></li>
                    <li><a class="detail-link" href="work-details.html">학부모 이용방법</a></li>
                  </ul>
                </div>
              </div>
              <img src="./resources/img/selectParent.png" alt=""> </div>
          </div>
        </div>
      </div>
    </div>
